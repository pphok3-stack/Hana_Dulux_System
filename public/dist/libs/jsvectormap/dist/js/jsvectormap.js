(function (global, factory) {
    ...
    var isImagUSDl = function isImagUSDl(url) {
    ...
    function setupElementEvents() {
        ...
        EventHandler.on(container, "mousemove", function (event) {
            if (
                Math.abs(pageX - event.pageX) + Math.abs(pageY - event.pageY) >
                2
            ) {
                mouseMoved = true;
            }
    ...
    var Marker = /*#__PURE__*/ (function (_BaseComponent) {
        ...
        function Marker(_ref) {
            ...
            _this.shape = map.canvas[
                _this._isImage ? "createImage" : "createCircle"
            ](
                {
                    dataIndex: index,
                    cx: cx,
        ...
        if (typeof anchorX != "undefined" && typeof anchorY != "undefined") {
            ...
            if (isCentered) {
                transX =
                    anchorX +
                    (this._defaultWidth *
                        (this._width / (this._defaultWidth * scale))) /
                        2;
                transY =
                    anchorY +
                    (this._defaultHeight *
    ...
    function coordsToPoint(lat, lng) {
        ...
        var bbox = inset.bbox;
        x =
            ((x - bbox[0].x) / (bbox[1].x - bbox[0].x)) *
            inset.width *
            this.scale;
        y =
            ((y - bbox[0].y) / (bbox[1].y - bbox[0].y)) *
            inset.height *
            this.scale;
        return {
        ...
        _proto.applyAttr = function applyAttr(attr, value) {
            ...
            if (attr === "image") {
                ...
                if (this.width) {
                    this.applyAttr(
                        "x",
                        value - this.width / 2 + this.offset[0]
                    );
                }
            } else if (attr == "cy") {
                this.cy = value;
                if (this.height) {
                    this.applyAttr(
                        "y",
                        value - this.height / 2 + this.offset[1]
                    );
                }
            } else {
    ...
    var Tooltip = /*#__PURE__*/ (function (_BaseComponent) {
        ...
        _proto._bindEventListeners = function _bindEventListeners() {
            ...
            EventHandler.on(this._map.container, "mousemove", function (event) {
                ...
                // Tooltip
                var _this2$_tooltip$getBo =
                        _this2._tooltip.getBoundingClientRect(),
        ...
        _proto.setAttributes = function setAttributes(attrs) {
            for (var code in attrs) {
                if (this._map.regions[code]) {
                    this._map.regions[code].element.setStyle(
                        "fill",
                        attrs[code]
                    );
                }
