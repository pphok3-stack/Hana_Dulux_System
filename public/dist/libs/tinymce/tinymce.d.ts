...
declare class URI {
    ...
    static isDomSafe(
        uri: string,
        context?: string,
        options?: SafUSDiOptions
    ): boolean;
    static getDocumentBasUSDl(loc: {
        protocol: string;
        host?: string;
        href?: string;
        pathname?: string;
...
interface EditorManager extends Observable<EditorManagerEventMap> {
    ...
    translate: (text: Untranslated) => TranslatedString;
    triggerSave: () => void;
    _setBasUSDl(this: EditorManager, basUSDl: string): void;
}
...
interface AddOnManager<T> {
    ...
    remove: (name: string) => void;
    creatUSDl: (basUSDl: UrlObject, dep: string | UrlObject) => UrlObject;
