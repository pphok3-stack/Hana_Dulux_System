                            ...
                            if (n.length) {
                                ...
                                if (g.test(e)) {
                                    ...
                                    r.month
                                        ...
                                        ? (v = t
                                              .shortMonths(o)
                                              .indexOf(y[r.shortMonth]))
                                        : r.longMonth &&
                                          (v = t
                                              .longMonths(o)
                                              .indexOf(y[r.longMonth]));
                ...
                h = (function (t) {
                    function e(e) {
                        ...
                        (i.options = s(s({}, i.options), e)),
                            ...
                            i.options.elementEnd ||
                                (i.options.allowRepick = !1),
                        ...
                        if (i.options.showTooltip)
                            if (i.options.tooltipPluralSelector)
                                i.pluralSelector =
                                    i.options.tooltipPluralSelector;
                            else
                                try {
                                    var u = new Intl.PluralRules(
                                        i.options.lang
                                    );
                    ...
                    return (
                        ...
                        (e.prototype.isSamePicker = function (t) {
                            return (
                                t.closest("." + p.litepicker) === this.picker
                            );
                        }),
                            ...
                            if (i && this.picker)
                                if (this.shouldShown(i)) this.show(i);
                                    ...
                                    if (i.classList.contains(p.dayItem)) {
                                        ...
                                        if (this.shouldCheckBookedDays()) {
                                            ...
                                            this.options.hotelMode &&
                                                ...
                                                (s = "()");
                                            var r =
                                                    this.options.bookedDays.filter(
                                                        function (t) {
                                                            return t instanceof
                                                                Array
                                                                ? t[0].isBetween(
                                    ...
                                    if (
                                        ...
                                        return (
                                            this.calendars[h].setMonth(
                                                this.calendars[h].getMonth() - d
                                            ),
                                    ...
                                    if (
                                        i.classList.contains(p.buttonNextMonth)
                                    ) {
                                        if (
                                            (t.preventDefault(),
                                            !this.isSamePicker(i))
                        ...
                        (e.prototype.showTooltip = function (t, e) {
                            ...
                            if (
                                ...
                                var l =
                                    this.picker.parentNode.getBoundingClientRect();
                                (r -= l.top), (a -= l.left);
                            ...
                            (r -= n.height),
                                ...
                                (i.style.left = a + "px"),
                                "function" ==
                                    typeof this.options.onShowTooltip &&
                            ...
                            if (
                                ...
                                if (
                                    (Array.prototype.slice
                                        .call(
                                            this.picker.querySelectorAll(
                                                "." + p.dayItem
                                            )
                                        )
                                        .forEach(function (t) {
                                            var i = new l.DateTime(
                                                    t.dataset.time
                                                ),
                                                o = e.renderDay(i);
                                            i.isBetween(n, s) &&
                                                o.classList.add(p.isInRange),
                                                (t.className = o.className);
                                        }),
                                    i.classList.add(p.isEndDate),
                                    r
                                        ? (o && o.classList.add(p.isFlipped),
                                          i.classList.add(p.isFlipped))
                                        : (o && o.classList.remove(p.isFlipped),
                                          i.classList.remove(p.isFlipped)),
                                    this.options.showTooltip)
                                ) {
                                    var c = s.diff(n, "day");
                                    if (
                                        (this.options.hotelMode || (c += 1),
                                        c > 0)
                                    ) {
                        ...
                        (e.prototype.onInput = function (t) {
                            ...
                            if (
                                ...
                                (this.options.elementEnd
                                    ...
                                    ((r = o.clone()),
                                    (a = this.options.numberOfMonths - 1)),
                                    "function" ==
                        ...
                        (e.prototype.isShowning = function () {
                            return (
                                this.picker &&
                                "none" !== this.picker.style.display
                            );
                        }),
                    ...
                    return (
                        (t.prototype.render = function () {
                                    ...
                                    c.addEventListener("click", function (e) {
                                        e.preventDefault(),
                                            ...
                                            "function" ==
                                                typeof t.options
                                                    .resetBtnCallback &&
                                                t.options.resetBtnCallback.call(
                                                    t
                                                );
                                    }),
                                    e
                                        .querySelector(
                                            "." + s.monthItem + ":last-child"
                                        )
                            ...
                            if (
                                ...
                                if (
                                    "function" != typeof this.enableModuleRanges
                                )
                                    throw new Error(
                            ...
                            if (this.options.dropdowns.months) {
                                ...
                                c.addEventListener("change", function (t) {
                                    ...
                                    e.calendars[o].setMonth(Number(i.value)),
                                        e.render(),
                                        "function" ==
                                            typeof e.options.onChangeMonth &&
                        ...
                        (t.prototype.renderDay = function (t) {
                            ...
                            this.options.highlightedDays.length &&
                                this.options.highlightedDays.filter(function (
                                    e
                                ) {
                                    return e instanceof Array
                                        ? t.isBetween(e[0], e[1], "[]")
                    ...
                    s &&
                        ...
                        (o +=
                            "\n/*# sourceMappingURL=data:application/json;base64,".concat(
                                btoa(
                                    unescape(
                                        encodUSDIComponent(JSON.stringify(s))
                                    )
                                ),
                                " */"
                            )),
                ...
                if (this.options.mobileFriendly && l.isMobile()) {
                    ...
                    return (
                        (this.picker.style.top =
                            "calc(50% - " + n.height / 2 + "px)"),
                        (this.picker.style.left =
                            "calc(50% - " + n.width / 2 + "px)"),
