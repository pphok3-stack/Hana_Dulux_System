...
(function (global) {
     ...
     * encodUSDIComponent() produces the same result except encoding spaces as `%20` instead of `+`.
     */
    var serializeParam = function (value) {
        return encodUSDIComponent(value).replace(/%20/g, "+");
    };
    var deserializeParam = function (value) {
        return decodUSDIComponent(String(value).replace(/\+/g, " "));
    };
 ...
 */
function parsUSDl(input, safe = true) {
    let url = input;
    if (safe) {
    ...
    constructor(target, options) {
        ...
        switch (_type) {
            case "div":
                ...
                if (is.element(iframe)) {
                    // Detect provider
                    url = parsUSDl(iframe.getAttribute("src"));
