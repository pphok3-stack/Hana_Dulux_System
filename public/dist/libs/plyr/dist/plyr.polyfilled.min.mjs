...
!(function (e) {
    var t = (function () {
        ...
        s = function (e) {
            return encodUSDIComponent(e).replace(/%20/g, "+");
        },
        n = function (e) {
            return decodUSDIComponent(String(e).replace(/\+/g, " "));
        };
    (function () {
        try {
                ...
                (function () {
                    var t = e.URL,
                        i = function (t, i) {
                            ...
                            if (
                                i &&
                                (void 0 === e.location || i !== e.location.href)
                            ) {
                                (i = i.toLowerCase()),
                                    ((s = (n =
                            ...
                            (r.href = t),
                                s && (n.body.appendChild(r), (r.href = r.href));
                        ...
                        if (is$1.string(t) && n.watch) {
                            var r = new MutationObserver(function (i) {
                                Array.from(i).forEach(function (i) {
                                    Array.from(i.addedNodes).forEach(function (
                                        i
                                    ) {
                                        is$1.element(i) &&
                                            matches$1(i, t) &&
...
const controls = {
    ...
    createTime(e, t) {
        const i = getAttributesFromSelector(
        ...
        on.call(
            ...
            (i) => {
                ...
                if (!s && [" ", "ArrowRight"].includes(i.key))
                    controls.showMenuPanel.call(this, t, !0);
                else {
                    let t;
                    " " !== i.key &&
    ...
    setQualityMenu(e) {
        ...
        is.array(e) &&
            (this.options.quality = dedupe(e).filter((e) =>
    ...
    setCaptionsMenu() {
        ...
        const n = i.map((e, i) => ({
            ...
            badge:
                e.language &&
                controls.createBadge.call(this, e.language.toUpperCase()),
            list: t,
            type: "language",
        }));
        n.unshift({
    ...
    toggleMenu(e) {
        ...
        if (is.boolean(e)) n = e;
            ...
            const s = is.function(e.composedPath)
                    ? e.composedPath()[0]
                    : e.target,
                r = t.contains(s);
            ...
            const e = controls.getMenuSize.call(this, i),
                t = (e) => {
                    e.target === s &&
                        ...
                        ((s.style.width = ""),
                        (s.style.height = ""),
                        off.call(this, s, transitionEndEvent, t));
                };
        ...
        return (
            dedupe(
                ...
                if (
                    ...
                    "duration" === a &&
                        c.appendChild(r.call(this, "duration", u)),
                    "mute" === a || "volume" === a)
                ) {
    ...
    inject() {
        ...
        if (
            (s[is.element(e) ? "insertAdjacentElement" : "insertAdjacentHTML"](
                "afterbegin",
                e
            ),
            ...
            if (n !== i) {
                if (
                    ...
                    return (
                        ...
                        void captions.set.call(this, e.indexOf(t))
                    );
                }
...
class Fullscreen {
    constructor(e) {
        _defineProperty$1(this, "onChange", () => {
            ...
            on.call(this, this.player.elements.container, "keydown", (e) =>
                this.trapFocus(e)
            ),
            this.update();
    }
...
const ui = {
    ...
    build() {
        ...
        is.element(this.elements.controls) ||
            ...
            this.poster &&
                ui.setPoster.call(this, this.poster, !1).catch(() => {}),
        ...
        return t && this.poster
            ...
            : (this.media.setAttribute("data-poster", e),
              ...
              ready
                  ...
                  .catch((t) => {
                      throw (
                          (e === this.poster && ui.togglePoster.call(this, !1),
                          t)
                      );
                  })
                  .then(() => {
    ...
    migrateStyles() {
        Object.values({ ...this.media.style })
            .filter(
                (e) => !is.empty(e) && is.string(e) && e.startsWith("--plyr")
            )
            .forEach((e) => {
        ...
        _defineProperty$1(this, "firstTouch", () => {
            ...
            _defineProperty$1(this, "media", () => {
                const { player: e } = this,
                    { elements: t } = e;
                if (
                    (on.call(e, e.media, "timeupdate seeking seeked", (t) =>
                        controls.timeUpdate.call(e, t)
                    ),
                    on.call(
                        e,
                        e.media,
                        "durationchange loadeddata loadedmetadata",
                        (t) => controls.durationUpdate.call(e, t)
                    ),
                    ...
                    on.call(
                        ...
                        (t) => controls.updateProgress.call(e, t)
                    ),
                    on.call(e, e.media, "volumechange", (t) =>
                        controls.updateVolume.call(e, t)
                    ),
                    on.call(
                        e,
                        e.media,
                        "playing play pause ended emptied timeupdate",
                        (t) => ui.checkPlaying.call(e, t)
                    ),
                    on.call(e, e.media, "waiting canplay seeked playing", (t) =>
                        ui.checkLoading.call(e, t)
                    ),
                    e.supported.ui && e.config.clickToPlay && !e.isAudio)
                ) {
                    const i = getElement.call(
                        e,
            ...
            _defineProperty$1(this, "controls", () => {
                ...
                if (
                    ...
                    Array.from(t).forEach((e) =>
                        this.bind(e, i, (e) => repaint(e.target))
                    );
                }
                this.bind(
                    t.inputs.seek,
                    ...
                    this.bind(
                        ...
                        (t) => controls.updateSeekTooltip.call(e, t)
                    ),
                    ...
                    browser.isWebKit &&
                        Array.from(
                            ...
                            this.bind(t, "input", (t) =>
                                controls.updateRangeFill.call(e, t.target)
                            );
                        }),
    ...
    handleKey(e) {
        ...
        if (c) {
            ...
            if (is.element(n)) {
                ...
                if (" " === e.key && matches(n, 'button, [role^="menuitem"]'))
                    return;
            }
            switch (
                ([
    ...
    ready() {
        ...
        t.customControls ||
            fetch(format(e.config.urls.vimeo.api, h)).then((t) => {
                !is.empty(t) &&
                    t.thumbnail_url &&
                    ui.setPoster.call(e, t.thumbnail_url).catch(() => {});
            }),
    ...
    constructor(e) {
        _defineProperty$1(this, "load", () => {
            ...
            _defineProperty$1(
                ...
                "on",
                (e, t) => (
                    is.array(this.events[e]) || (this.events[e] = []),
    ...
    constructor(e) {
        _defineProperty$1(this, "load", () => {
            ...
            _defineProperty$1(this, "setScrubbingContainerSize", () => {
                const { width: e, height: t } = fitRatio(
              ...
              this.destroy.call(
                  ...
                  () => {
                      ...
                      Object.assign(this, {
                          ...
                          this.isHTML5 &&
                              source.insertElements.call(this, "source", t),
...
class Plyr {
    constructor(e, t) {
        if (
            ...
            _defineProperty$1(this, "supports", (e) =>
                support.mime.call(this, e)
            ),
            (this.timers = {}),
            (this.ready = !1),
            (this.loading = !1),
